export default [
  ...
  {
    type: 'Styles',
    selectors: ['article', 'aside', ':heading', 'hgroup', 'nav', 'section'],
    styles: [
      {
        property: 'display',
        value: 'block',
  ...
  },
  {
    ...
    styles: [
      ...
      {
        property: 'min-block-size',
        value: 'calc-size(auto, max(size, 24px, 1lh))',
      },
      {
        property: 'min-inline-size',
        value: 'calc-size(auto, max(size, 24px))',
      },
      {
        property: 'display',
        value: 'inline-flex',
  ...
  {
    type: 'Styles',
    selectors: ['select > button:first-child'],
    styles: [
      {
        property: 'all',
        value: 'unset',
